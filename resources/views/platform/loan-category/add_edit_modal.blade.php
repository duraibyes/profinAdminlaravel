...
<!--end::Header-->
<!--begin::Body-->
<form id="add_category_form" class="form" action="#" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="row mb-7">
                            <div class="col-md-6">
                                ...
                                <div class="mb-7">
                                    <label class="d-block fw-bold fs-6 mb-5">Category Icon</label>
                                    <div class="form-text">
                                ...
                                <div class="image-input image-input-outline manual-image-logo"
                                    ...
                                    <label
                                        ...
                                        <input type="file" name="category_icon" id="readUrllogo"
                                            accept=".png, .jpg, .jpeg" />
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Description"
                                    name="description" id="description" cols="30" rows="2">{{ $info->description ?? '' }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div
                                    ...
                                    <input class="form-check-input" type="checkbox" name="status" value="1"
                                        @if ((isset($info->status) && $info->status == 'active') || !isset($info->status)) checked @endif />
                                </div>
                            </div>
...
<script>
    ...
    var add_url = "{{ route('loan-category.save') }}";

    // Class definition
    var KTUsersAddRole = function() {
        // Shared variables
        const element = document.getElementById('kt_common_add_form');
        const form = element.querySelector('#add_category_form');
